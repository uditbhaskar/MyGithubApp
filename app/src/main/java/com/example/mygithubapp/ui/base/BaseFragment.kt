...
import com.example.mygithubapp.di.component.DaggerFragmentComponent

import com.example.mygithubapp.di.component.FragmentComponent
...
abstract class BaseFragment<VM : BaseViewModel> : Fragment() {
    ...
    private fun buildFragmentComponent() =
        DaggerFragmentComponent
            .builder()
            .applicationComponent((context!!.applicationContext as MyGithubApp).applicationComponent)
